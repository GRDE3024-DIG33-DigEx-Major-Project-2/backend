...
// COUNTRY
{
         ...
         description: "The Sydney Country Music Festival is a three-day celebration of country music featuring performances by some of the biggest names in the industry. Attendees can enjoy live music, food trucks, and a family-friendly atmosphere. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
         ...
         description: "The Boots and Hats Hoedown is a fun-filled evening of country music, line dancing, and western-themed activities. All proceeds from the event go towards supporting local charities and community projects. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[4].id,
         ...
         description: "The Southern Sounds Showcase brings together emerging country music talents from the Southern region. It's a night of soulful melodies and intimate performances in a cozy venue setting. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[5].id,
         ...
         description: "The Country BBQ Cook-Off and Music Fest is a unique blend of country music and mouthwatering BBQ. Enjoy the tunes, savor delicious barbecue, and witness BBQ teams compete for the title of  "Best BBQ in Sydney. " ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[6].id,
         ...
         description: "The Country Christmas Spectacular is a heartwarming holiday concert featuring country music stars performing traditional Christmas favorites and country-infused holiday tunes. It's a festive evening for the whole family to enjoy. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// JAZZ
{
      ...
      //   OrganizerId: organizers[7].id,
         ...
         description: "The Sydney Jazz Weekend is a three-day extravaganza of smooth jazz performances by renowned local and international artists. The event offers a relaxed and elegant atmosphere, perfect for jazz enthusiasts and newcomers alike. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[8].id,
         ...
         description: "Jazz Under the Stars is a magical evening of jazz music set in the picturesque surroundings of the Sydney Botanic Gardens. The event offers an unforgettable experience of music, nature, and fine dining. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[10].id,
         ...
         venueName:  "The Vanguard, Newtown ",
         description: "Jazz Fusion Fusion is a cutting-edge jazz event that explores the fusion of jazz with various contemporary genres, including funk, rock, and electronic music. Prepare for an evening of experimental sounds and mind-blowing performances. ",
         summary:  "PAID SHOW IN SYDNEY ",
       ...
       }, 
{
      ...
      //   OrganizerId: organizers[6].id,
         ...
         venueName:  "Sydney Opera House ",
         description: "The Jazz Legends Tribute is a night dedicated to honoring jazz icons from the past and present. A star-studded lineup of jazz virtuosos will take the stage to pay homage to the legends who shaped the genre. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// ELECTRONIC
{
      ...
      //   OrganizerId: organizers[11].id,
         ...
         description: "ElectraWave Festival is a two-day celebration of electronic dance music, featuring some of the biggest names in the EDM industry. Prepare for mind-blowing visuals, energetic performances, and an unforgettable dance party experience. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[12].id,
         ...
         description: "Neon Nights Rave is an electrifying night of non-stop electronic beats, neon lights, and vibrant party vibes. Get ready to dance until the early hours of the morning amidst an immersive neon wonderland. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[13].id,
         ...
         description: "SynthWave Sensations brings together the best of retro synthwave and modern electronic music. Dance to nostalgic tunes and contemporary bangers as the artists create an electrifying atmosphere. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[14].id,
         ...
         description: "Techno Evolution is a cutting-edge techno music event in a warehouse setting, showcasing the evolution of techno sounds. Expect dark, mesmerizing beats and an immersive audio-visual experience. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[15].id,
         ...
         description: "Electric Dreams Showcase is an upscale electronic music event featuring a blend of progressive house, trance, and melodic techno. The stunning venue and carefully curated lineup promise a night of pure musical euphoria. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// REGGAE
{
      ...
      //   OrganizerId: organizers[16].id,
         ...
         description: "Reggae Vibes Fest is a one-day celebration of reggae music and Caribbean culture. Get ready to experience the laid-back rhythms, vibrant performances, and delicious Caribbean cuisine in the picturesque setting of Bondi Beach. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[17].id,
         ...
         description: "Island Jam Session is a night dedicated to the infectious beats of reggae, dancehall, and ska music. Join the groove as talented local and international artists take the stage for an unforgettable reggae experience. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[18].id,
         ...
         description: "The Reggae Sunset Cruise offers a unique way to enjoy reggae beats with the stunning backdrop of Sydney Harbour at sunset. Dance to the rhythms, feel the sea breeze, and watch the city lights as you sail through the iconic harbor. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[19].id,
         ...
         venueName:  "The Metro Theatre, Sydney CBD ",
         description: "Roots Reggae Revival brings together legendary and up-and-coming reggae artists for a night of roots, rocksteady, and conscious reggae music. Immerse yourself in the uplifting and positive vibes of the reggae genre. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-09-16 18:00:00 ",
         endDate: " 2023-09-16 20:00:00 "
         address:  "G2/624 George St ",
...
// DANCE
{
      ...
      //   OrganizerId: organizers[21].id,
         ...
         description: "Electric Dance Nation is a high-energy dance music extravaganza featuring top DJs and performers from around the world. With stunning visual effects and immersive sound, this event promises an electrifying experience. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[14].id,
         ...
         description: "The Techno Warehouse Rave is an underground dance music event, featuring cutting-edge techno and tech-house beats in a secret industrial location. Get ready to dance the night away in an intimate and immersive setting. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[13].id,
         ...
         description: "The Tropical Groove Beach Party is a day-to-night dance extravaganza set on the sandy shores of Manly Beach. Dance to the best tropical and house beats while enjoying the beach vibes and stunning ocean views. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[18].id,
         ...
         description: "Summer Dance Escape is a two-day dance music festival held at the iconic Luna Park. Experience a thrilling combination of electrifying music, carnival rides, and breathtaking harbor views. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[20].id,
         ...
         description: "Club Nights is the ultimate New Year's Eve dance party, held at one of Sydney's most prestigious nightclubs. Dance into the new year with top DJs, dazzling light displays, and a vibrant atmosphere. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// METAL
{
      ...
      //   OrganizerId: organizers[22].id,
         ...
         venueName:  "The Enmore Theatre, Newtown ",
         description: "Metal Mayhem Fest is a night of headbanging and moshing to some of the best metal bands in the scene. Prepare for a high-energy event featuring both local and international metal acts. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2024-04-08 18:00:00 ",
...

{
      ...
      //   OrganizerId: organizers[23].id,
         ...
         description: "Sydney Metal Invasion brings together a diverse lineup of metal subgenres, from thrash to death metal, creating a night of sonic mayhem and intense performances. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[24].id,
         ...
         description: "Metal Masters Showcase is a celebration of the best local metal talent in Sydney. Witness the power and diversity of the city's metal scene with this epic showcase event. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[25].id,
         ...
         description: "Unleashed Fury Fest promises a night of raw and aggressive metal performances, with bands that push the boundaries of the genre and deliver unrelenting fury on stage. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[26].id,
         ...
         venueName:  "The Metro Theatre, Sydney CBD ",
         description: "Metal Masquerade Ball is a unique metal experience, combining the energy of metal music with the elegance of a masquerade ball. Dress up, headbang, and enjoy a night of metal decadence. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// HIP HOP
{
      ...
      //   OrganizerId: organizers[27].id,
         ...
         description: "Hip Hop Extravaganza is a night of urban music, showcasing the best in hip-hop and R&B. Join the party and experience a fusion of beats, live performances, and dance battles. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[28].id,
         ...
         description: "Sydney Rap Cypher Showcase is a platform for local hip-hop artists to shine. Experience the raw talent of the city's rap scene with freestyle cyphers, rap battles, and live performances. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[20].id,
         ...
         description: "Hip Hop Block Party is a family-friendly event celebrating hip-hop culture. Enjoy live music, dance performances, street art, and food trucks in a vibrant and inclusive atmosphere. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[29].id,
         ...
         venueName:  "The Basement, Circular Quay ",
         description: "Underground Hip Hop Showdown is an evening dedicated to showcasing the best underground hip-hop talent. Immerse yourself in the authentic sounds of the local hip-hop scene. ",
         summary:  "PAID SHOW IN SYDNEY ",
       ...
       }, 
{
      ...
      //   OrganizerId: organizers[21].id,
         ...
         venueName:  "Ivy Nightclub, Sydney CBD ",
         description: "Hip Hop All-Stars Jam brings together a lineup of legendary hip-hop artists for an unforgettable night of classic hits and iconic performances. Get ready to party with the hip-hop greats. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// POP
{
      ...
      //   OrganizerId: organizers[30].id,
         ...
         description: "PopMania Festival is a celebration of all things pop music, featuring chart-topping artists and emerging talents. Enjoy a day filled with infectious pop melodies and a lively, family-friendly atmosphere. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[31].id,
         ...
         venueName:  "The Metro Theatre, Sydney CBD ",
         description: "Sydney Pop Showcase highlights the best pop acts from around the world, creating a night of electrifying performances and unforgettable pop hits. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[32].id,
         ...
         venueName:  "The Enmore Theatre, Newtown ",
         description: "Pop Divas Live! pays tribute to the biggest female pop stars of today and yesterday. Experience a night of powerhouse vocals and iconic performances by the ultimate pop divas. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[20].id,
         ...
         venueName:  "Luna Park, Milsons Point ",
         description: "Neon Pop Party is a vibrant and visually stunning pop music event, featuring top artists and neon-themed décor for a night of dancing and partying. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[33].id,
         ...
         description: "The New Year's Eve Pop Bash is the ultimate way to ring in the new year, with a star-studded lineup of pop superstars and a spectacular countdown celebration. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-12-31 20:00:00 ",
...
// SOLO
{
      ...
      //   OrganizerId: organizers[34].id,
         ...
         description: "Soulful Serenade features the captivating voice of Emma Thompson in an intimate solo performance. Experience a night of soulful melodies and heartfelt ballads at the iconic City Recital Hall. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[35].id,
         ...
         venueName:  "The Basement, Circular Quay ",
         description: "Acoustic Vibes presents the raw and authentic talent of James Morrison in an unplugged solo performance. Enjoy a night of soulful acoustic tunes in the intimate setting of The Basement. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2024-06-10 20:00:00 ",
...

{
      ...
      //   OrganizerId: organizers[36].id,
         ...
         description: "Piano Serenity features the artistry of Sarah Walker, enchanting the audience with her mesmerizing piano solos in the intimate Utzon Room of the Sydney Opera House. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-08-26 19:00:00 ",
...

{
      ...
      //   OrganizerId: organizers[37].id,
         ...
         venueName:  "The Vanguard, Newtown ",
         description: "Guitar Unplugged showcases the incredible guitar skills of Alex Turner in an acoustic solo performance. Get ready for a night of spellbinding guitar arrangements and soulful melodies. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-10-14 18:30:00 ",
...

{
      ...
      //   OrganizerId: organizers[38].id,
         ...
         description: "Saxophone Soliloquy presents the soulful and sultry sounds of Lisa Davis on the saxophone. Enjoy a night of smooth jazz and soul classics in the intimate ambiance of The Brass Monkey. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-12-09 20:00:00 ",
...
// INSTRUMENTAL
{
      ...
      //   OrganizerId: organizers[39].id,
         ...
         description: "Symphony of Strings is an enchanting evening of orchestral music, featuring a repertoire of classical masterpieces and contemporary compositions, all centered around the beauty of strings. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[40].id,
         ...
         description: "Jazz Piano Soirée presents an intimate night of exceptional jazz piano performances, featuring renowned pianists and emerging talents showcasing their skills and improvisations. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[41].id,
         ...
         venueName:  "The Factory Theatre, Marrickville ",
         description: "Guitar Masters Showcase celebrates the artistry of guitar virtuosos from various genres, creating a night of mind-blowing guitar solos, innovative techniques, and instrumental brilliance. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[42].id,
         ...
         description: "Flute and Harp Serenade presents a captivating blend of flute and harp performances in the serene setting of the Art Gallery of New South Wales' Domain Theatre. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[43].id,
         ...
         description: "Experimental Soundscape Showcase explores the world of experimental and ambient music, featuring avant-garde artists who push the boundaries of traditional soundscapes. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// RAP
{
      ...
      //   OrganizerId: organizers[44].id,
         ...
         venueName:  "Hordern Pavilion, Moore Park ",
         description: "Sydney Rap Fest is a celebration of hip-hop culture, featuring top rap artists, electrifying performances, and freestyle rap battles that showcase the best talent in the scene. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[45].id,
         ...
         venueName:  "Carriageworks, Eveleigh ",
         description: "Rap Cypher Showdown is a night of intense rap battles and freestyle competitions, where the city's most skilled lyricists go head-to-head in a battle for supremacy. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[46].id,
         ...
         venueName:  "The Enmore Theatre, Newtown ",
         description: "Urban Groove Night is a vibrant party featuring the best in urban music, from hip-hop to R&B. Dance the night away to the hottest beats from top urban artists. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[47].id,
         ...
         venueName:  "The Factory Theatre, Marrickville ",
         description: "Women in Rap Showcase shines a spotlight on the talented female rappers in the industry, featuring empowering performances and celebrating the contributions of women to hip-hop. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[48].id,
         title:  "Rap City Jam ",
         venueName:  "Qudos Bank Arena, Sydney Olympic Park ",
         description: "Rap City Jam brings together the biggest names in rap music for an epic night of hits and high-energy performances, closing the year with an unforgettable rap celebration. ",
         summary:  "PAID SHOW IN SYDNEY ",
...
// INTERNATIONAL
{
      ...
      //   OrganizerId: organizers[49].id,
         ...
         description: "World Music Fest celebrates the diversity of music from around the globe, featuring artists from different countries and cultures. Experience a vibrant fusion of sounds and rhythms. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[50].id,
         ...
         venueName:  "Luna Park, Milsons Point ",
         description: "Latin Fiesta Night is an electrifying celebration of Latin music and dance, featuring top artists from the Latin music scene. Get ready to move to the infectious rhythms of salsa, bachata, and more. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[51].id,
         ...
         venueName:  "The Enmore Theatre, Newtown ",
         description: "Asian Beats Showcase highlights the diversity of music from Asia, featuring a lineup of Asian artists who blend traditional sounds with contemporary beats. ",
         summary:  "PAID SHOW IN SYDNEY ",
         startDate:  " 2023-08-12 19:00:00 ",
         endDate: " 2023-08-12 23:00:00 "
         address:  "118-132 Enmore Rd ",
...

{
      ...
      //   OrganizerId: organizers[52].id,
         ...
         venueName:  "Qudos Bank Arena, Sydney Olympic Park ",
         description: "K-Pop Extravaganza brings the hottest K-Pop acts to the stage for an electrifying night of music, dance, and captivating performances. ",
         summary:  "PAID SHOW IN SYDNEY ",
...

{
      ...
      //   OrganizerId: organizers[53].id,
         ...
         venueName:  "The Factory Theatre, Marrickville ",
         description: "European Beats Gala showcases the best of European music, featuring a diverse lineup of artists from various European countries, representing a wide range of genres. ",
         summary:  "PAID SHOW IN SYDNEY ",
